                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form method="post" class="form" action="{{route('admin.post.store')}}" enctype="multipart/form-data">
                                                @csrf
                                                <!--begin::Input group-->
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mb-2">News or Post Title:</label>
                                                    <!--end::Label-->
                                                ...
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold form-label mb-2">Select Post Image:</label>
                                                    <!--end::Label-->
...
{{--        symbol-circle --}}
        symbol-50px overflow-hidden me-3">
                                            <a href="/">
                                                <div class="">
                                                    <img src="/{{$post->image}}" alt="{{$post->title}}" style="width: 150px"/>
                                                </div>
                                            </a>
                                        </div>
                                        <!--end::Avatar-->
                                        ...
                                        {{--            <a class="text-gray-800 text-hover-primary mb-1">{{$post->user->first_name}} {{$post->user->registration_name}}</a>--}}
                                    ...
                                    <td class="text-end">
                                        <a href="{{route('admin.post.edit',$post->id)}}" class="btn btn-primary  btn-flex btn-center btn-sm">
                                        ...
                                        <a href="{{route('admin.post.destroy',$post->id)}}" class="btn btn-danger  btn-flex btn-center btn-sm">
