            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ config('app.name', Lang::get('titles.app'))}} Members List
                    </h1>
                    <!--end::Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            {{ config('app.name', Lang::get('titles.app'))}} Members
                        </li>
                        <!--end::Item-->
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form method="post" class="form" action="{{route('admin.team.store')}}" enctype="multipart/form-data">
                                                @csrf
                                                <!--begin::Input group-->
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mb-2">Member Full Name:</label>
                                                    <!--end::Label-->

                                                    <!--begin::Input-->
                                                    <input type="text" name="name" data-kt-user-table-filter="search" class="form-control form-control-solid  "
                                                           placeholder="QS. Queen White Mshana"/>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-10">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="required fs-6 fw-semibold form-label mb-2">Member Image:</label>
                                                ...
                                                <div class="row mb-10">
                                                    <div class="col-md-12">
                                                        <!--begin::Label-->
                                                        <label class="required fs-6 fw-semibold form-label mb-2">Member Bio:</label>
                                                        <!--end::Label-->

                                                        <!--begin::Input-->
                                                        <textarea name="bio" rows="10" class="form-control form-control-solid "
                                                                  placeholder="Members BIO"></textarea>
                                                    </div>
...
{{--        symbol-circle --}}
        symbol-50px overflow-hidden me-3">
                                            <a href="/">
                                                <div class="">
                                                    <img src="/{{$member->image}}" alt="{{$member->title}}" style="width: 150px"/>
                                                </div>
                                            </a>
                                        </div>
                                        <!--end::Avatar-->
                                        ...
                                        {{--            <a class="text-gray-800 text-hover-primary mb-1">{{$member->user->first_name}} {{$member->user->registration_name}}</a>--}}
                                    ...
                                    <td class="text-end">
                                        <a href="{{route('admin.team.edit',$member->id)}}" class="btn btn-primary  btn-flex btn-center btn-sm">
                                        ...
                                        <a href="{{route('admin.team.destroy',$member->id)}}" class="btn btn-danger  btn-flex btn-center btn-sm">
