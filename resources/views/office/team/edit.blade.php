                    ...
                    <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-12">
                                <!--begin::Form-->
                                <form action="{{route('admin.team.update',$team->id)}}" method="post" enctype="multipart/form-data" id="kt_invoice_form">
                                    @csrf
                                    <!--begin::Wrapper-->
                                    <div class="mb-0">
                                        <!--begin::Row-->
                                        <div class="row gx-10 mb-5">
                                            <!--begin::Col-->
                                            <h3 class=" fw-bold text-gray-700 mb-3">Edit Team Member</h3>
                                            <div class="separator separator-dashed"></div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <label class="form-label fs-6 mb-1">Team Member Name*</label>
                                                    <input required type="text" value="{{old('name') ?  : $team->name}}"
                                                           name="name" class="form-control form-control-solid"/>
                                                    @if($errors->has('name'))
                                                ...
                                                <div class="col-lg-6">
                                                    <label class="form-label fs-6 mb-1">Team Member Title*</label>
                                                    <input required type="text" value="{{old('title') ?  : $team->title}}"
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <img src="/{{$team->image}}" alt="{{$team->title}}" style="width: 300px"/>
                                                    <input accept=".png, .jpg, .jpeg"  type="file" name="file" class="form-control form-control-solid" placeholder="yotube.com"/>
                                                    @if($errors->has('file'))
                                                        <p style="color: red">{{ $errors->first('file') }}</p>
                                                    @endif
                                                </div>
                                                <hr>
                                                <label class="form-label fs-6 fw-bold text-gray-700">Bio</label>
                ...
                setInterval(function() {
                    if (change.length() > 0) {
                        ...
                        */
                        ...
                        $.post('{{route('admin.team.update.desc',$team->id)}}}', {
