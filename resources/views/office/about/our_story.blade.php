                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
                                    ...
                                    <i class="ki-duotone ki-exit-up fs-2"><span class="path1"></span><span
                                            class="path2"></span></i> Update Story
                                </button>
                                <!--end::Export-->
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form method="post" class="form" action="{{route('admin.update.story')}}" enctype="multipart/form-data">
                                                @csrf
                                                <div class="fv-row mb-10">
                                                    <label class="fs-6 fw-semibold form-label mb-2">Story:</label>
                                                    <textarea name="story" data-kt-user-table-filter="search" class="form-control form-control-solid" rows="7"></textarea>
                                                </div>
                    ...
                    <div class="card-body py-4">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Our Story</th>
                            </tr>
                            </thead>
