            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ config('app.name', Lang::get('titles.app'))}} Safaris List
                    </h1>
                    <!--end::Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            {{ config('app.name', Lang::get('titles.app'))}} Safaris
                        </li>
                        <!--end::Item-->
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-750px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bold">Add Safari</h2>
                                            <!--end::Modal title-->
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form method="post" class="form" action="{{route('admin.safari.store')}}" enctype="multipart/form-data">
                                                @csrf
                                                <!--begin::Input group-->
                                                ...
                                                <div class="row mb-10">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input required type="number" name="days" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-10">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input required type="text" name="availability" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="required fs-6 fw-semibold form-label mb-2">Price <strong>(USD)</strong>:</label>
                                                        <input required type="number" name="price" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                </div>

                                                <div class="row mb-10">
                                                    <div class="col-md-12">
                                                        <label class="required fs-6 fw-semibold form-label mb-2">Highlights <small style="color: red">Separate with coma (,)</small>:</label>
                                                        <input required type="text" name="highlights" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
...
{{--        symbol-circle --}}
        symbol-50px overflow-hidden me-3">
                                            <a href="/">
                                                <div class="">
                                                    <img src="/{{$safari->image}}" alt="{{$safari->title}}" style="width: 150px"/>
                                                </div>
                                            </a>
                                        </div>
                                        <!--end::Avatar-->
                                        ...
                                        {{--            <a class="text-gray-800 text-hover-primary mb-1">{{$safari->user->first_name}} {{$safari->user->registration_name}}</a>--}}
                                        {{--            <span>{{$safari->user->phone}}</span>--}}
                                        {{--        </div>--}}
                                        <!--begin::User details-->
                                    </td>
                                    <td >
                                    ...
                                    <td class="text-end">
                                        <a href="{{route('admin.safari.edit',$safari->id)}}" class="btn btn-primary  btn-flex btn-center btn-sm">
                                        ...
                                        <a href="{{route('admin.safari.destroy',$safari->id)}}" class="btn btn-danger  btn-flex btn-center btn-sm">
