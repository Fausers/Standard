            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ config('app.name', Lang::get('titles.app'))}} Resources List
                    </h1>
                    <!--end::Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            {{ config('app.name', Lang::get('titles.app'))}} Resources
                        </li>
                        <!--end::Item-->
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-750px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form method="post" class="form" action="{{route('admin.resource.store')}}" enctype="multipart/form-data">
                                                @csrf
                                                <!--begin::Input group-->
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold form-label mb-2">Resources Title:</label>
                                                    <!--end::Label-->
                                                ...
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold form-label mb-2">Resource Type:</label>
                                                    <!--end::Label-->

                                                    <!--begin::Input-->
                                                    <select name="category" data-kt-user-table-filter="search" class="form-control form-control-solid">
                                                ...
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold form-label mb-2">Upload Resource:</label>
                                                    <!--end::Label-->

                                                    <!--begin::Input-->
                                                    <input type="file" name="file" data-kt-user-table-filter="search"
                                                           class="form-control form-control-solid "
                                                           placeholder="Search slides" accept=".pdf"/>
                                                    <!--end::Input-->
                                                </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            @foreach($resources as $resource)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        {{-- <a href="{{route('admin.impact.edit',$resource->id)}}" class="btn btn-primary  btn-flex btn-center btn-sm">
                                        ...
                                        <a href="{{route('admin.resource.destroy',$resource->id)}}" class="btn btn-danger  btn-flex btn-center btn-sm">
