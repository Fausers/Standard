            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ config('app.name', Lang::get('titles.app'))}} Categories List
                    </h1>
                    <!--end::Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            {{ config('app.name', Lang::get('titles.app'))}} Categories
                        </li>
                        <!--end::Item-->
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
                                    ...
                                    <i class="ki-duotone ki-exit-up fs-2"><span class="path1"></span><span
                                            class="path2"></span></i> Add Category
                                </button>
                                <!--end::Export-->
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form method="post" class="form" action="{{route('admin.category.store')}}" enctype="multipart/form-data">
                                                @csrf
                                                <!--begin::Input group-->
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mb-2">Category Name:</label>
                                                    <!--end::Label-->
                                                ...
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="fs-6 fw-semibold form-label mb-2">Category Description:</label>
                                                    <!--end::Label-->

                                                    <!--begin::Input-->
                                                    <input type="text" name="description" data-kt-user-table-filter="search" class="form-control form-control-solid  "
                                                ...
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold form-label mb-2">Category Image:</label>
                                                    <!--end::Label-->
...
{{--        symbol-circle --}}
        symbol-50px overflow-hidden me-3">
                                            <a href="/">
                                                <div class="">
                                                    <img src="/{{$category->image}}" alt="{{$category->title}}" style="width: 150px"/>
                                                </div>
                                            </a>
                                        </div>
                                        <!--end::Avatar-->
                                        ...
                                        {{--            <a class="text-gray-800 text-hover-primary mb-1">{{$category->user->first_name}} {{$category->user->registration_name}}</a>--}}
                                        {{--            <span>{{$category->user->phone}}</span>--}}
                                        {{--        </div>--}}
                                        <!--begin::User details-->
                                    </td>
                                    <td >
                                    ...
                                    <td class="text-end">
                                        <button class="btn btn-primary  btn-flex btn-center btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_category_{{$category->id}}">
                                        ...
                                        <a href="{{route('admin.category.destroy',$category->id)}}" class="btn btn-danger  btn-flex btn-center btn-sm">
                                ...
                                <div class="modal fade" id="kt_modal_edit_category_{{$category->id}}" tabindex="-1" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered mw-650px">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                <!--begin::Form-->
                                                <form method="post" class="form" id="form_{{$category->id}}" action="{{route('admin.category.update',$category->id)}}" enctype="multipart/form-data">
                                                    @csrf
                                                    <!--begin::Input group-->
                                                    <div class="fv-row mb-10">
                                                        <!--begin::Label-->
                                                        ...
                                                        <!--begin::Input-->
                                                        <input type="text" value="{{$category->title}}" name="title" data-kt-user-table-filter="search" class="form-control form-control-solid  " placeholder="Title"/>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Input group-->
                                                ...
                                                <div class="fv-row mb-10">
                                                    ...
                                                    <!--begin::Input-->
                                                    <input type="text" value="{{$category->description}}" name="description" data-kt-user-table-filter="search" class="form-control form-control-solid "
                                                           placeholder="Description"/>
                                                    <!--end::Input-->
                                                </div>
                                                    ...
                                                    <div class="fv-row mb-10">
                                                        ...
                                                        <label class="required fs-6 fw-semibold form-label mb-2">Category Image:</label>
                                                        <!--end::Label-->
                                                        <img src="/{{$category->image}}" style="width: 50%">
                                                    ...
                                                    <div class="text-center">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" form="form_{{$category->id}}" data-kt-users-modal-action="submit">
                                                    <span class="indicator-label">
                                                        Submit
                                                    </span>
                                                            <span class="indicator-progress">
