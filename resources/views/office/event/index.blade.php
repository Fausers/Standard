            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                    ...
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                        {{ config('app.name', Lang::get('titles.app'))}} Events List
                    </h1>
                    <!--end::Title-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            {{ config('app.name', Lang::get('titles.app'))}} Events
                        </li>
                        <!--end::Item-->
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-750px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                            <!--begin::Form-->
                                            <form method="post" class="form" action="{{route('admin.event.store')}}" enctype="multipart/form-data">
                                                @csrf
                                                <!--begin::Input group-->
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold form-label mb-2">Event Title:</label>
                                                    <!--end::Label-->

                                                    <!--begin::Input-->
                                                    <input required type="text" name="title" data-kt-user-table-filter="search" class="form-control form-control-solid  "
                                                           placeholder="Title"/>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="row mb-10">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input required type="text" name="organizer" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-10">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input required type="date" name="start_date" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="required fs-6 fw-semibold form-label mb-2">End Date:</label>
                                                        <input required type="date" name="end_date" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-10">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input required type="time" name="start_time" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="required fs-6 fw-semibold form-label mb-2">End Time:</label>
                                                        <input required type="time" name="end_time" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-10">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input required type="text" name="phone" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row mb-10">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input required type="text" name="address" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="required fs-6 fw-semibold form-label mb-2">Venue:</label>
                                                        <input required type="text" name="venue" class="form-control form-control-solid" placeholder=""/>
                                                    </div>
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="fv-row mb-10">
                                                    <!--begin::Label-->
                                                    <label class="required fs-6 fw-semibold form-label mb-2">Event Image:</label>
                                                    <!--end::Label-->
...
{{--        symbol-circle --}}
        symbol-50px overflow-hidden me-3">
                                            <a href="/">
                                                <div class="">
                                                    <img src="/{{$event->image}}" alt="{{$event->title}}" style="width: 150px"/>
                                                </div>
                                            </a>
                                        </div>
                                        <!--end::Avatar-->
                                        ...
                                        {{--            <a class="text-gray-800 text-hover-primary mb-1">{{$event->user->first_name}} {{$event->user->registration_name}}</a>--}}
                                    ...
                                    <td>
                                        @if($event->featured)
                                            <div class="badge badge-light-success fw-bold">Featured</div>
                                        @else
                                            <div class="badge badge-light-primary fw-bold">Listed</div>
                                        @endif
                                    </td>

                                    <td class="text-end">
                                        <a href="{{route('admin.event.edit',$event->id)}}" class="btn btn-primary  btn-flex btn-center btn-sm">
                                        ...
                                        <a href="{{route('admin.event.destroy',$event->id)}}" class="btn btn-danger  btn-flex btn-center btn-sm">
