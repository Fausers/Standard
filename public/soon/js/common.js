	...
	menu_icon.on("click", function(){
		if($("html").hasClass("mobile-v")){
			if(navigation_inner_wrapper.hasClass("open-menu") != true){
				navigation_inner_wrapper.show("blind",{direction: "horizontal"}, nav_show, 60).addClass("open-menu");
				...
				if(menu_icon.hasClass("close-icon")){
					navigation_inner_wrapper.hide("blind",{direction: "horizontal"}, nav_hide, 60).removeClass("open-menu");
					navigation_li.animate({
						top: "-30px",
						opacity: 0
					}, 800, navigation_out);
